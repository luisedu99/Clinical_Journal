...
public class Patients {
    ...
    public Patients(String patient_name, String patient_lastname, String patient_email, String patient_pass, String patient_phone, String patient_descrip, int patient_role) {
